...
export class AdminController {
  ...
  requestPasswordReset = asyncHandler(
    async (req: Request<unknown, unknown, RequestPasswordResetInput>, res: Response) => {
   ...
   */
  loginWithResetCode = asyncHandler(
    async (req: Request<unknown, unknown, LoginWithResetCodeInput>, res: Response) => {
   ...
   */
  listPayments = asyncHandler<unknown, unknown, unknown, ListSessionsInput>(
    async (req: Request<unknown, unknown, unknown, ListSessionsInput>, res: Response) => {
   ...
   */
  resendEmail = asyncHandler<{ id: string }>(
    async (req: AuthRequest<{ id: string }>, res: Response) => {
      const { id } = req.params;

      const session =
        (await sessionService.findBySessionId(id)) || (await sessionService.findById(id));
      if (!session) {
        throw new Error('Session not found');
      }
   ...
   */
  updateEmail = asyncHandler<{ id: string }, unknown, UpdateEmailInput>(
    async (req: AuthRequest<{ id: string }, unknown, UpdateEmailInput>, res: Response) => {
      const { id } = req.params;
      const { email } = req.body;
   ...
   */
  sendEmail = asyncHandler<{ id: string }, unknown, SendEmailInput>(
    async (req: AuthRequest<{ id: string }, unknown, SendEmailInput>, res: Response) => {
      const { id } = req.params;
   ...
   */
  grantAccess = asyncHandler<{ id: string }>(
    async (req: AuthRequest<{ id: string }>, res: Response) => {
      const { id } = req.params;
   ...
   * List activity log
   */
  listActions = asyncHandler<unknown, unknown, unknown, ListActionsInput>(
    async (req: Request<unknown, unknown, unknown, ListActionsInput>, res: Response) => {
      const query = req.query;
   ...
   */
  createSession = asyncHandler<unknown, unknown, CreateSessionInput>(
    async (req: AuthRequest<unknown, unknown, CreateSessionInput>, res: Response) => {
      const data = req.body;
   ...
   */
  exportData = asyncHandler<unknown, unknown, unknown, ExportInput>(
    async (req: Request<unknown, unknown, unknown, ExportInput>, res: Response) => {
      const query = req.query;
